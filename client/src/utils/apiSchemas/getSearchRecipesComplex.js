//this folder is to show the outputs of different api calls for reference when trying to know what to expect.about_content
//this particular aile is for getSerchRecipesComplex().
