const fakedata = {
  ...
  //name, aisle, amount, unit
  const potato = root.missedIngredients[0].name;




//   const extendedIngredients = root.missedIngredients.map(({name, aisle, amount, unit}) => ({name, aisle, }))
    ...
    const extendedIngredients = loopThroughArray(root.missedIngredients)

console.log(extendedIngredients[0])
