...
class AdvancedSearch extends Component {
  constructor({addRecipe, deleteRecipe, user}){
    super();
    this.state = {
      query: "",
      submitClicked: false,
    ...
    Object.assign(this, {addRecipe, deleteRecipe, user});
  }
    ...
    return (
      <div>
        <Container style={{ minHeight: "80%" }}>
          <h5>{this.user && <span>Welcome, {this.user}😘</span>}</h5> 
          ...
          <RecipeSearchResults results={results} submitClicked={submitClicked} addRecipe={this.addRecipe} deleteRecipe={this.deleteRecipe} />
        </Container>
      </div>
    );
  }
